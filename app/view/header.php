        ...
        <div class="span3">
            <div id="profile" class="affix">
                ...
                <div class="today_show">
                    <div class="today"><div class="today_title">Today</div><div class="today_num">1</div></div>
                    <div class="total"><div class="total_title">Total</div><div class="total_num"><? echo "1";?></div></div>
                </div>
<!-- START CONTENT -->